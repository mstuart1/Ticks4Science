...
describe("Login", () => {
  ...
  describe("POST /api/user/login", () => {
    ...
    it.only("should fail to login this non-user", (done) => {
      const login_info = {
    ...
    it.only("should fail to login this bad password", (done) => {
      const login_info = {
        email: existEmail,
  ...
  describe("PUT /api/login/forgot", () => {
    it("should generate a token and email it for this CFA user", (done) => {
      // const login_info = { email: cfa.email };
      const login_info = {
        email: "michelle1.stuart@rutgers.edu",
      };
      chai
        .request(server)
    ...
    it("should generate a token and email it for this admin user", (done) => {
      const login_info = {
        email: admin.email,
      };
      chai
