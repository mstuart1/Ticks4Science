...
export const inputElemArray1 = [
  {id: 1, type: 'text', name: 'userMuni', required: true, placeholder: 'Where you live', label: 'City*' },
...
export const inputElemArray2 = [
  ...
  {id: 5, type: 'text', name: 'tickMuni', required: true, placeholder: 'Where tick was found', label: 'City*' },
...
export const bittenInfoArray = [
    {id: 8, type: 'text', name: 'bittenMuni', required: true, placeholder: 'Where the bitten person lives', label: 'City of bitten person*' },
